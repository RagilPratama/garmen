    ...
    <div class="min-h-screen flex">
        ...
        <div class="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-amber-600 via-orange-500 to-yellow-400 items-center justify-center">
            ...
            <div class="absolute inset-0">
                <div v-for="i in 12" :key="i" class="absolute rounded-full opacity-20 animate-float" :class="circleClass(i)" :style="circleStyle(i)"></div>
            </div>
            <!-- Wavy lines -->
            ...
            <div class="relative z-10 text-center text-white px-12">
                ...
                <p class="text-white/70 text-sm max-w-xs mx-auto leading-relaxed">Kelola seluruh proses produksi garmen Anda dengan mudah, dari bahan masuk hingga pengiriman ke toko.</p>
                <div class="mt-10 flex flex-wrap justify-center gap-3">
                    <div v-for="badge in badges" :key="badge" class="px-4 py-2 bg-white/20 backdrop-blur-sm rounded-full text-sm text-white border border-white/30 shadow">
                        {{ badge }}
                    </div>
                </div>
            </div>
        ...
        <div class="w-full lg:w-1/2 flex items-center justify-center bg-gray-50 px-6 py-12">
            <div class="w-full max-w-md">
                ...
                <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
                    ...
                    <!-- Error Alert -->
                    <div v-if="Object.keys(errors).length" class="mb-4 p-4 bg-red-50 border border-red-200 rounded-lg flex items-start gap-3">
                ...
                <p class="text-center text-xs text-gray-400 mt-6">&copy; {{ new Date().getFullYear() }} GarmenApp. Hak cipta dilindungi.</p>
            </div>
        </div>
    </div>
</template>
