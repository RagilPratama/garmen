        ...
        <div class="max-w-2xl">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center gap-3 mb-6">
                    <Link href="/barang-kirim-toko" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition">
...
const submit = () => {
    isEdit.value ? form.put(`/barang-kirim-toko/${props.item.id}`) : form.post('/barang-kirim-toko');
};
</script>
