        ...
        <div class="max-w-2xl">
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                <div class="flex items-center gap-3 mb-6">
                    <Link href="/barang-masuk-kantor" class="p-2 text-gray-400 hover:text-gray-600 hover:bg-gray-100 rounded-lg transition">
...
const form = useForm({
    ...
    tanggal_kirim: props.item?.tanggal_kirim?.split('T')[0] ?? '',
    po: props.item?.po ?? '',
...
const submit = () => {
    isEdit.value ? form.put(`/barang-masuk-kantor/${props.item.id}`) : form.post('/barang-masuk-kantor');
};
</script>
