<template>
    <AdminLayout title="Barang Masuk Kantor">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="px-5 py-3.5">
                                <span class="inline-flex items-center gap-1 text-xs font-mono bg-teal-50 text-teal-700 border border-teal-100 px-2 py-0.5 rounded">
                            ...
                            <td class="px-5 py-3.5 text-center">
                                <span class="inline-flex items-center justify-center px-2.5 py-1 bg-teal-50 text-teal-700 text-xs font-semibold rounded-full">
        ...
        <!-- DETAIL MODAL -->
        <Modal v-model="showDetail" :title="'Detail Surat Jalan: ' + (detailGroup?.no_surat_jalan ?? '')" size="xl">
        ...
        <Modal v-model="showModal" title="Tambah Barang Masuk Kantor" size="xl">
            <div v-if="!modelOptions.length" class="mb-4 flex items-center gap-2 text-sm text-amber-700 bg-amber-50 border border-amber-200 rounded-lg px-4 py-3">
                <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                Belum ada data dari
                <strong class="ml-1">Proses Finishing</strong>
                . Lengkapi Pcs Barang Jadi terlebih dahulu.
            </div>
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="max-h-72 overflow-y-auto border border-gray-200 rounded-xl divide-y divide-gray-100">
                        ...
                        <div v-if="!filteredOptions.length" class="px-4 py-8 text-center text-sm text-gray-400">Tidak ada stok finishing yang tersedia</div>
                    </div>
                </div>
            ...
            <form @submit.prevent="submitEdit" class="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        placeholder="0"
                    />
                    <p v-if="editForm.errors?.pcs_barang_jadi" class="mt-1 text-xs text-red-500">
...
const filteredOptions = computed(() => {
    ...
    return props.modelOptions.filter((o) => o.model.toLowerCase().includes(q));
});
