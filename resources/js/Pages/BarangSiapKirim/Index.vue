                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-sm">
                        ...
                        <tbody class="divide-y divide-gray-50">
                            ...
                            <tr v-for="(row, idx) in filtered" :key="row.model" class="hover:bg-gray-50/60 transition-colors">
                                ...
                                <td class="px-6 py-3.5 text-right">
                                    <span class="inline-flex items-center justify-center min-w-[48px] font-bold text-base" :class="(row.siap_kirim || 0) > 0 ? 'text-emerald-600' : 'text-gray-400'">
                                        {{ row.siap_kirim || 0 }}
                                    </span>
                                </td>
                                <td class="px-6 py-3.5 text-center">
                                    <span
                                        :class="[
                                            ...
                                            (row.siap_kirim || 0) > 0 ? 'bg-emerald-50 text-emerald-700' : 'bg-gray-100 text-gray-500',
                                        ]"
                                    >
                                        <span class="w-1.5 h-1.5 rounded-full" :class="(row.siap_kirim || 0) > 0 ? 'bg-emerald-500' : 'bg-gray-400'"></span>
                ...
                <div class="flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-amber-700 mt-1 leading-relaxed">
                            ...
                            = Total Barang Jadi (dari Proses Finishing) &minus; yang sudah masuk ke Kantor.
                            <br />
                            <strong>Stok di Kantor</strong>
                            = Barang Masuk Kantor &minus; Kirim ke Toko &minus; Jual Gudang.
                            <br />
                            <strong>Kirim ke Toko</strong>
                            adalah barang yang dikirim dari Kantor ke Toko (Jomei/Kamiko).
                            <br />
