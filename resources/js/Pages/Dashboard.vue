                        ...
                        <div class="bg-gradient-to-br from-blue-50 to-cyan-50 rounded-lg p-4 border border-blue-100">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p
                                        class="text-2xl font-bold text-blue-700 truncate"
                                        :title="formatRupiah(Number(saldoKasGudang.saldo_cash || 0) + Number(saldoKasGudang.saldo_transfer || 0) + Number(saldoKasGudang.saldo_debit || 0))"
                                    >
                        ...
                        <div class="bg-gradient-to-br from-orange-50 to-amber-50 rounded-lg p-4 border border-orange-100">
                            <div class="flex items-center justify-between mb-3">
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p
                                        class="text-2xl font-bold text-orange-700 truncate"
                                        :title="formatRupiah(Number(saldoKasGarmen.saldo_cash || 0) + Number(saldoKasGarmen.saldo_transfer || 0) + Number(saldoKasGarmen.saldo_debit || 0))"
                                    >
