    ...
    <AdminLayout title="Laporan Defect">
        <div class="space-y-5">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                ...
                >
                    <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" :class="sumberStyle(s.sumber).bg">
                ...
                <div v-if="!summary.length" class="col-span-3 bg-white rounded-2xl border border-gray-100 shadow-sm px-5 py-8 text-center text-sm text-gray-400">Belum ada data defect</div>
            </div>
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-gray-800">
                                Rincian Defect
                                <span v-if="activeSumber" class="ml-2 text-xs font-normal text-white px-2 py-0.5 rounded-full capitalize" :class="sumberStyle(activeSumber).badge">
                                    Proses {{ activeSumber }}
                                </span>
                            </h2>
                    ...
                    <table class="w-full text-sm">
                        ...
                        <tbody>
                            ...
                            >
                                ...
                                <td class="px-5 py-3.5">
                                    <span class="inline-flex items-center px-2.5 py-1 text-xs font-semibold rounded-full capitalize" :class="sumberStyle(row.sumber).badge">
                                        Proses {{ row.sumber }}
                                    </span>
                                </td>
                                ...
                                <td class="px-5 py-3.5 text-center">
                                    <span class="inline-flex items-center justify-center px-2.5 py-1 bg-red-50 text-red-700 text-xs font-bold rounded-full">{{ row.pcs_defect }} pcs</span>
                                </td>
