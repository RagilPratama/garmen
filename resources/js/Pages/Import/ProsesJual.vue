            ...
            <div class="bg-white rounded-lg shadow p-6">
                ...
                <div class="mb-6 p-4 bg-blue-50 rounded">
                    ...
                    <div class="flex gap-3 mt-3">
                        <a :href="route('import.proses-jual.template')" class="inline-block px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700">Download Template</a>
                        <a :href="route('import.proses-jual.export-models')" class="inline-block px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700">Export Nama Model</a>
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="file" @change="handleFile" accept=".xlsx,.xls,.csv" required class="w-full border rounded px-3 py-2" />
                    ...
                    <div class="flex gap-3">
                        ...
                        <Link :href="route('proses-jual.index')" class="px-6 py-2 bg-gray-300 rounded hover:bg-gray-400">Batal</Link>
                    </div>
                </form>
            </div>
        </div>
