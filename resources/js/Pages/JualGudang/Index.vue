    ...
    <Modal v-model="showModal" title="Tambah Jual Gudang" size="xl">
      ...
      <form @submit.prevent="submit" class="space-y-4">
        ...
        <div>
          ...
          <div class="max-h-64 overflow-y-auto border border-gray-200 rounded-xl divide-y divide-gray-100">
            ...
            <div v-if="!filteredOptions.length" class="px-4 py-8 text-center text-sm text-gray-400">
              Tidak ada stok gudang yang tersedia
            </div>
          </div>
          <!-- Total -->
        ...
        <div class="flex justify-end gap-3 pt-2 border-t border-gray-100">
          ...
          <button type="submit" :disabled="processing || !checkedItems.size" class="px-5 py-2.5 text-sm text-white bg-amber-500 hover:bg-amber-600 rounded-lg disabled:opacity-60 flex items-center gap-2">
      ...
      <form @submit.prevent="submitEdit" class="space-y-4">
        ...
        <div>
          ...
          <input v-model.number="editForm.harga_satuan" type="number" min="0" required
            class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-amber-400 focus:border-transparent transition bg-white"/>
          <p v-if="editForm.pcs && editForm.harga_satuan" class="mt-1 text-xs text-amber-600">
