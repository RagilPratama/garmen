    ...
    <AdminLayout title="Kas Gudang (Kantor)">
        <div class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div class="bg-gradient-to-br from-blue-400 to-blue-500 rounded-xl p-5 text-white shadow-md">
                    <p class="text-xs font-medium uppercase tracking-wide opacity-80">Cash</p>
                    <p class="text-2xl font-bold mt-1">
                        {{ formatRupiah(Number(saldoKas?.saldo_cash || 0)) }}
                    </p>
                </div>
                <div class="bg-gradient-to-br from-cyan-400 to-cyan-500 rounded-xl p-5 text-white shadow-md">
                    <p class="text-xs font-medium uppercase tracking-wide opacity-80">Transfer</p>
                    <p class="text-2xl font-bold mt-1">
                        {{ formatRupiah(Number(saldoKas?.saldo_transfer || 0)) }}
                    </p>
                </div>
                <div class="bg-gradient-to-br from-purple-400 to-purple-500 rounded-xl p-5 text-white shadow-md">
            ...
            <div class="bg-gradient-to-br from-indigo-500 to-blue-600 rounded-xl p-6 text-white shadow-lg">
                <p class="text-sm font-medium uppercase tracking-wide opacity-90">Total Saldo Kas Gudang</p>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                ...
                <div class="px-6 py-5 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            <h2 class="text-base font-semibold text-gray-800">Kas Gudang</h2>
        ...
        <Modal v-model="showModal" title="Tambah Transaksi Kas Gudang">
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-2">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input v-model="form.jenis" type="radio" value="masuk" class="text-blue-500" />
                            <span class="text-sm text-gray-700">Masuk</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input v-model="form.jenis" type="radio" value="keluar" class="text-blue-500" />
                ...
                <div>
                    ...
                    <div class="flex gap-4 mt-2">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input v-model="form.metode_bayar" type="radio" value="cash" class="text-blue-500" />
                            <span class="text-sm text-gray-700">Cash</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input v-model="form.metode_bayar" type="radio" value="transfer" class="text-blue-500" />
                            <span class="text-sm text-gray-700">Transfer</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input v-model="form.metode_bayar" type="radio" value="debit" class="text-blue-500" />
