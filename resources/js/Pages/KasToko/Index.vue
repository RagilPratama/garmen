    ...
    <AdminLayout title="Kas Toko">
        <div class="space-y-5">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <div v-for="(kas, tokoId) in saldoKas" :key="tokoId" class="bg-gradient-to-br from-green-400 to-emerald-500 rounded-xl p-5 text-white shadow-md">
                        ...
                        <tbody>
                            ...
                            >
                                <td class="px-5 py-3.5">
                                    <span
                                        class="inline-flex items-center justify-center w-6 h-6 rounded-full bg-gray-100 text-xs font-medium text-gray-500 group-hover:bg-green-100 group-hover:text-green-700 transition-colors"
                                    >
        ...
        <Modal v-model="showTransferToGudangModal" title="Transfer ke Gudang">
            <form @submit.prevent="submitTransferToGudang" class="space-y-4">
                ...
                <div class="flex justify-end gap-3 pt-2 border-t border-gray-100">
                    <button type="button" @click="showTransferToGudangModal = false" class="px-5 py-2.5 text-sm text-gray-700 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors">
                        Batal
                    </button>
                    <button
                        type="submit"
