        ...
        <div class="space-y-6">
            ...
            <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <button
                        @click="exportPdf"
                        class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl flex items-center gap-2 text-sm font-semibold transition-all shadow-sm shadow-indigo-200"
                    >
                    ...
                    <tbody class="divide-y divide-gray-50">
                        <tr v-for="item in filteredData" :key="item.po" class="hover:bg-gray-50/50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-right">
                                <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-bold bg-green-100 text-green-800">{{ item.pcs_jadi }} Pcs</span>
                            </td>
