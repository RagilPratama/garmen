        ...
        <Modal v-model="showModal" title="Tambah Jual Toko" size="xl">
            ...
            <form @submit.prevent="submit" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="max-h-64 overflow-y-auto border border-gray-200 rounded-xl divide-y divide-gray-100" :class="isAdmin && !tokoId ? 'opacity-50 pointer-events-none' : ''">
                        <label
                        ...
                        <div v-if="!filteredOptions.length" class="px-4 py-8 text-center text-sm text-gray-400">Tidak ada stok toko yang tersedia</div>
                    </div>
                    <!-- Total -->
            ...
            <form @submit.prevent="submitEdit" class="space-y-4">
                ...
                <div>
                    ...
                    <input
                        ...
                        class="w-full px-4 py-2.5 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-violet-400 focus:border-transparent transition bg-white"
                    />
                    <p v-if="editForm.pcs && editForm.harga_satuan" class="mt-1 text-xs text-violet-600">Total: {{ formatRupiah(editForm.pcs * editForm.harga_satuan) }}</p>
                </div>
                <div class="flex justify-end gap-3 pt-2 border-t border-gray-100">
