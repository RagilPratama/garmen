                ...
                <div class="flex items-center gap-3">
                    <div class="w-9 h-9 rounded-xl bg-orange-50 flex items-center justify-center">
                        <svg class="w-5 h-5 text-orange-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 10h4m0 0l-4-4m4 4l-4 4M3 12a9 9 0 0118 0" />
                        </svg>
                    </div>
                    <div>
                                ...
                                <div class="flex flex-col items-center gap-3">
                                    <div class="w-16 h-16 rounded-2xl bg-gray-100 flex items-center justify-center">
                                        <svg class="w-8 h-8 text-gray-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17 10h4m0 0l-4-4m4 4l-4 4M3 12a9 9 0 0118 0" />
                                        </svg>
                                    </div>
        ...
        <Modal v-model="showDetail" :title="'Detail Keluar: ' + (detailItem?.kode_bahan ?? '')" size="xl">
            <div v-if="detailItem" class="space-y-4">
                <div class="flex flex-wrap items-center gap-4 text-sm text-gray-600 bg-gray-50 rounded-lg px-4 py-3">
                    <span>
                        <span class="font-medium text-gray-700">Nama Bahan:</span>
                        {{ detailItem.nama_bahan || '—' }}
                    </span>
                    <span>
                        <span class="font-medium text-gray-700">Total Keluar:</span>
                        <span class="text-orange-700 font-semibold">{{ formatYard(detailItem.total_yard) }} yd</span>
                    </span>
                    <span>
                        <span class="font-medium text-gray-700">Sudah Dipotong:</span>
                        <span class="text-red-600 font-semibold">{{ formatYard(detailItem.sudah_dipotong) }} yd</span>
                    </span>
                    <span>
                        <span class="font-medium text-gray-700">Sisa di Garmen:</span>
                    ...
                    <span>
                        <span class="font-medium text-gray-700">Total Nilai:</span>
                        <span class="text-violet-700">{{ formatRupiah(detailItem.total_nilai) }}</span>
                    </span>
                </div>
