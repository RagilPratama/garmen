            ...
            <section class="relative">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                    <div
                        ...
                        :class="[filterStage === k ? 'ring-2 ring-offset-2 ' + stageMeta[k].ringColor : 'hover:border-slate-300']"
                    >
                        <!-- Decorative background element -->
                        <div class="absolute -right-2 -bottom-2 w-12 h-12 rounded-full opacity-[0.03] transition-transform duration-500 group-hover:scale-150" :class="stageMeta[k].bgColor"></div>
                        ...
                        <div class="absolute bottom-0 left-0 h-1 bg-slate-100 w-full overflow-hidden">
                            <div class="h-full transition-all duration-1000 ease-out" :class="stageMeta[k].bgColor" :style="{ width: filterStage === k ? '100%' : '0%' }"></div>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <div class="bg-white rounded-3xl border border-slate-200/60 shadow-sm overflow-hidden min-h-[500px]">
                ...
                <div class="px-8 py-6 border-b border-slate-100 bg-slate-50/30 flex flex-wrap items-center justify-between gap-6">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div class="relative group">
                            <svg
                                class="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-400 group-focus-within:text-amber-500 transition-colors"
                                fill="none"
                                stroke="currentColor"
                                viewBox="0 0 24 24"
                            >
                ...
                <div v-else class="divide-y divide-slate-100">
                    <div v-for="group in filteredPOs" :key="group.po" class="group/po">
                        <!-- Elegant PO Header -->
                        <div @click="togglePo(group.po)" class="w-full h-16 flex items-center justify-between px-8 bg-white hover:bg-slate-50/50 cursor-pointer transition-colors">
                            <div class="flex items-center gap-6">
                                <!-- Toggle icon -->
                                <div
                                    class="w-6 h-6 rounded-full flex items-center justify-center border border-slate-200 text-slate-400 group-hover/po:border-amber-400 group-hover/po:text-amber-500 transition-all"
                            ...
                            <div class="flex gap-2">
                                <span
                                    v-for="stg in group.uniqueStages"
                                    :key="stg"
                                                ...
                                                <div class="relative z-10 flex flex-col items-center group/node">
                                                    ...
                                                    <div class="absolute top-7 whitespace-nowrap text-center">
                                                        <span
                                                            ...
                                                            :class="row.current_stage === 'selesai' ? 'text-emerald-600' : 'text-slate-300'"
                                                        >
                                                            SELESAI
                                                        </span>
                                                    </div>
